...
class Evaluation
{
	...
	static ReadMatrix u1m = new ReadMatrix();
	

	public static int[][] testData()throws FileNotFoundException, IOException
	{
		BufferedReader br = new BufferedReader(new FileReader("E:/documents/Documents/KLTN2019/db/CFDB/toBeRated.csv"));
	...
	public static String CrossValidation(String UserItem)throws FileNotFoundException, IOException
	{
		...
		int num = 0;
		BufferedReader br = new BufferedReader(new FileReader("E:/documents/Documents/KLTN2019/db/CFDB/ratings.csv"));
		StringTokenizer st = null;
		String row;
		while ((row = br.readLine()) != null)
		{
	...
	{
		BufferedReader br = new BufferedReader(new FileReader("E:/documents/Documents/KLTN2019/db/CFDB/users.csv"));
		StringTokenizer st = null;
		String row;
	...
	public static void main(String args[])throws IOException
	{
		...
		String UserItem = "User";//args[0]
		String SimPCJ = "Cosine";//args[1]
		int[][] matrix = u1m.CreateMatrixInt1M();
		int[][] test = testData();
		...
		if (UserItem.equals("User"))
		{	
			PrintWriter writer = new PrintWriter("E:/documents/Documents/KLTN2019/db/CFDB/rsdemo/result1.csv", "UTF-8");
		...
		{	
			PrintWriter writer = new PrintWriter("E:/documents/Documents/KLTN2019/db/CFDB/rsdemo/result2.csv", "UTF-8");
			for (int i = 0; i < opRating.length; ++i)
			{
				writer.println(opRating[i]);
			}
		...
		{	
			PrintWriter writer = new PrintWriter("E:/documents/Documents/KLTN2019/db/CFDB/rsdemo/result3.csv", "UTF-8");
			for (int i = 0; i < opRating.length; ++i)
			{
				writer.println(opRating[i]);
			}
